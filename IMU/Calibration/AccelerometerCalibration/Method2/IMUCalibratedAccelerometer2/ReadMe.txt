Before you run the "IMUCalibratedAccelerometer2" file go to "IMUAccelerometerCalibration2_Step2" and follow the instructions. 
...
->Close the serial monitor and run the "Graphs_Acceleration2_NormalVsCalibrated_IMU.m" in MATLAB
