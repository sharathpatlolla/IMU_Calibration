...
{  
  ...
  else if((Converted_ax>1/sqrt(3)-tolerance)&&(Converted_ax<1/sqrt(3)+tolerance)&&(Converted_ay>1/sqrt(3)-tolerance)&&(Converted_ay<1/sqrt(3)+tolerance)&&(Converted_az>1/sqrt(3)-tolerance)&&(Converted_az<1/sqrt(3)+tolerance)){
    Serial.print (millis()-ti,DEC);
    Serial.print ("\t");    
    Serial.print(j+7);
    Serial.print ("\t");
