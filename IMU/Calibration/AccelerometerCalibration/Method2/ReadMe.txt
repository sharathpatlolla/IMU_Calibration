...
IMUAccelerometerCalibration2_Step1 -> This code helps you to set the orientation of the IMU (It tells the axis along which the gravity is aligned.)
IMUAccelerometerCalibration2_Step2 -> This code outputs the values which are the input for the MATLAB code.
IMUCalibratedAccelerometer2	  -> This code outputs the calibrated acceleration values.
